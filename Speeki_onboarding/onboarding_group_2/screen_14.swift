...
struct Screen14: View {
    ...
    @State private var navigateToScreen15 = false
            ...
            GeometryReader { geometry in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        CustomSlider(
                            position: $position,
                            leftOption: "Quickly adapt and steer it\nback on track.",
                            rightOption: "Feel flustered and lose\ntrack of my points."
                        )
                        ...
                        NavigationLink(destination: Screen14(), isActive: $navigateToScreen15) {
                            EmptyView()
                        }
                        HStack {
                            Spacer()
