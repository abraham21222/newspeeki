...
struct Screen13: View {
    ...
    @State private var navigateToScreen14 = false
            ...
            GeometryReader { geometry in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        CustomSlider(
                            position: $position,
                            leftOption: "Mirror their energy and\nspeaking style.",
                            rightOption: "Feel awkward trying to\nadjust my natural\nrhythm."
                        )
                        ...
                        NavigationLink(destination: Screen14(), isActive: $navigateToScreen14) {
                            EmptyView()
                        }
                        HStack {
                            Spacer()
