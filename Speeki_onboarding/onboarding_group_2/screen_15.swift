...
struct Screen15: View {
    ...
    @State private var navigateToScreen16 = false
            ...
            GeometryReader { geometry in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        CustomSlider(
                            position: $position,
                            leftOption: "Feel a warm connection\nand understanding.",
                            rightOption: "Doubt if they truly grasp\nthe depth of my story."
                        )
                        ...
                        NavigationLink(destination: screen_16(), isActive: $navigateToScreen16) {
                            EmptyView()
                        }
                        HStack {
                            Spacer()
