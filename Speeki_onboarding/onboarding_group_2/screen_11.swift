...
struct Screen11: View {
    ...
    @State private var navigateToScreen12 = false
            ...
            GeometryReader { geometry in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        CustomSlider(
                            position: $position,
                            leftOption: "Seamlessly switch\nbetween taking charge\nand supporting.",
                            rightOption: "Struggle to keep up with\nthe changing dynamics."
                        )

                        Spacer().frame(height: geometry.size.height * 0.08625) // Increased from 0.075
                        
                        // Navigation link and Group 21 image
                        NavigationLink(destination: Screen12(), isActive: $navigateToScreen12) {
                            EmptyView()
                        }
                        HStack {
                            Spacer()
