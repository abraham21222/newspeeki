...
struct Screen9: View {
    ...
    @State private var navigateToScreen10 = false
            ...
            GeometryReader { geometry in
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        CustomSlider(
                            position: $position,
                            leftOption: "Confidently pitch its\nunique features.",
                            rightOption: "Stumble through a few\nhesitant sentences."
                        )
                        ...
                        NavigationLink(destination: Screen10(), isActive: $navigateToScreen10) {
                            EmptyView()
                        }
                        HStack {
                            Spacer()
